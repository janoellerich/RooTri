...
function [ipmat] = RooTri(arg1, arg2, arg3, arg4, arg5)
    ...
    ipmat = intersec_mat_1(...
        find(lambda_mat(:,1) <=1 & lambda_mat(:,1) >= 0),:,:);
    ipmat = [ipmat; ...
        intersec_mat_2(...
        find(lambda_mat(:,2) <=1 & lambda_mat(:,2) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_3(...
        find(lambda_mat(:,3) <=1 & lambda_mat(:,3) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_4(...
        find(lambda_mat(:,4) <=1 & lambda_mat(:,4) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_5(...
        find(lambda_mat(:,5) <=1 & lambda_mat(:,5) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_6(...
        find(lambda_mat(:,6) <=1 & lambda_mat(:,6) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_7(...
        find(lambda_mat(:,7) <=1 & lambda_mat(:,7) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_8(...
        find(lambda_mat(:,8) <=1 & lambda_mat(:,8) >= 0),:,:)];
    ipmat = [ipmat; ...
        intersec_mat_9(...
        find(lambda_mat(:,9) <=1 & lambda_mat(:,9) >= 0),:,:)];
